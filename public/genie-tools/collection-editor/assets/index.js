...
const view = { COLLECTIONS: 0, ASSETS: 1 };
...
var _tmpl$$c = /* @__PURE__ */ template(`<div class="collection-box collection-header"><div class=input-grid><span>Collection:</span><input class=focussed placeholder="Collections must have name"type=text><span>Collection Template:</span><select aria-label="Collection Template"class=focussed default=default></select><span>Filename:</span><input class=focussed type=text></div><div class=flex-row style=margin-top:2rem><button type=button>Save</button><button type=button>Duplicate`), _tmpl$2$5 = /* @__PURE__ */ template(`<div id=sections><h2>Sections</h2><button type=button>Add Section`), _tmpl$3$1 = /* @__PURE__ */ template(`<option>`);
...
const Collection = (props) => {
  if (props.index !== "new-collection")
    upgrade(props.index);
  const [filename, setFilename] = createSignal(props.index.replace(".json", ""));
  const [collection, setCollection] = createSignal(props.index !== "new-collection" ? app.store.allCollections[props.index] : emptyCollection);
  ...
  return [(() => {
    var _el$ = _tmpl$$c(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.nextSibling, _el$5 = _el$4.nextSibling, _el$6 = _el$5.nextSibling, _el$7 = _el$6.nextSibling, _el$8 = _el$7.nextSibling, _el$9 = _el$2.nextSibling, _el$0 = _el$9.firstChild, _el$1 = _el$0.nextSibling;
    _el$4.addEventListener("change", (e) => updateCollection("name", e.target.value));
    _el$6.addEventListener("change", (e) => updateCollection("template", e.target.value));
    insert(_el$6, () => console.log("app.store.allAssets", app.store.allAssets), null);
    insert(_el$6, createComponent(For, {
      get each() {
        return Object.keys(app.store.allAssets);
      },
      children: (a) => createComponent(Show, {
        get when() {
          return a.startsWith("collection");
        },
        get children() {
          var _el$13 = _tmpl$3$1();
          _el$13.value = a;
          insert(_el$13, () => app.store.allAssets[a].name);
          return _el$13;
        }
      })
    }), null);
    _el$8.addEventListener("change", (e) => setFilename(e.target.value));
    _el$0.$$click = async () => await localSave("Collection saved!");
    _el$1.$$click = async () => {
      setFilename((f) => `${f}-duplicate`);
      updateCollection("name", `${collection().name}-duplicate`);
      await localSave("Collection duplicated!");
    };
    createRenderEffect(() => setAttribute(_el$8, "placeholder", collection().name.replaceAll(" ", "-").toLowerCase() ?? ""));
    createRenderEffect(() => _el$4.value = collection().name);
    createRenderEffect(() => _el$6.value = collection().template);
    createRenderEffect(() => _el$8.value = filename());
    return _el$;
  })(), (() => {
    var _el$10 = _tmpl$2$5(), _el$11 = _el$10.firstChild, _el$12 = _el$11.nextSibling;
    insert(_el$10, createComponent(For, {
      get each() {
        return collection().sections;
      },
      children: (section, index) => createComponent(Section, {
        get name() {
          return section.name;
        },
        section,
        ...
        removeSection: () => {
          let sections = unwrap(collection().sections).filter((s, i) => i != index());
          setCollection((c) => ({
            ...c,
            sections
          }));
...
var _tmpl$$b = /* @__PURE__ */ template(`<div><h1>Genie Collections</h1><ul id=collections><li><em>Create New Collection`), _tmpl$2$4 = /* @__PURE__ */ template(`<li>`);
const Collections = () => {
  ...
  return (() => {
    ...
    _el$4.$$click = () => selectCollection("new-collection");
    insert(_el$3, createComponent(Show, {
      get when() {
        return app.store.allCollections;
      },
      get children() {
        return createComponent(For, {
          get each() {
            return Object.keys(app.store.allCollections);
          },
          children: (key) => (() => {
            var _el$5 = _tmpl$2$4();
...
var _tmpl$$9 = /*#__PURE__*/template(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 320 512"><path d="M88 160H38.7c-3.7 0-6.7-3-6.7-6.7 0-1.9.8-3.7 2.2-5L160 35.8l125.8 112.5c1.4 1.3 2.2 3.1 2.2 5 0 3.7-3 6.7-6.7 6.7H232c-17.7 0-32 14.3-32 32v272c0 8.8-7.2 16-16 16h-48c-8.8 0-16-7.2-16-16V192c0-17.7-14.3-32-32-32zM174 5.3c-3.9-3.4-8.8-5.3-14-5.3s-10.1 1.9-14 5.3L12.9 124.5C4.7 131.8 0 142.3 0 153.3 0 174.7 17.3 192 38.7 192H88v272c0 26.5 21.5 48 48 48h48c26.5 0 48-21.5 48-48V192h49.3c21.4 0 38.7-17.3 38.7-38.7 0-11-4.7-21.5-12.9-28.8L174 5.3z">`);
const Up = (props = {}) => (() => {
  var _el$ = _tmpl$$9();
  spread(_el$, props, true, true);
  return _el$;
...
var _tmpl$$8 = /*#__PURE__*/template(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 320 512"><path d="M88 352H38.7c-3.7 0-6.7 3-6.7 6.7 0 1.9.8 3.7 2.2 5L160 476.2l125.8-112.5c1.4-1.3 2.2-3.1 2.2-5 0-3.7-3-6.7-6.7-6.7H232c-17.7 0-32-14.3-32-32V48c0-8.8-7.2-16-16-16h-48c-8.8 0-16 7.2-16 16v272c0 17.7-14.3 32-32 32zm86 154.7c-3.8 3.4-8.8 5.3-14 5.3s-10.1-1.9-14-5.3L12.9 387.5C4.7 380.2 0 369.7 0 358.7 0 337.3 17.3 320 38.7 320H88V48c0-26.5 21.5-48 48-48h48c26.5 0 48 21.5 48 48v272h49.3c21.4 0 38.7 17.3 38.7 38.7 0 11-4.7 21.5-12.9 28.8L174 506.7z">`);
const Down = (props = {}) => (() => {
  var _el$ = _tmpl$$8();
  spread(_el$, props, true, true);
  return _el$;
...
var _tmpl$$7 = /*#__PURE__*/template(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 576 512"><path d="M117.2 136C160.3 96 217.6 64 288 64s127.7 32 170.8 72c43.1 40 71.9 88 85.2 120-13.3 32-42.1 80-85.2 120S358.4 448 288 448s-127.7-32-170.8-72C74.1 336 45.3 288 32 256c13.3-32 42.1-80 85.2-120zM288 32c-80.8 0-145.5 36.8-192.6 80.6C48.6 156 17.3 208 2.5 243.7c-3.3 7.9-3.3 16.7 0 24.6C17.3 304 48.6 356 95.4 399.4 142.5 443.2 207.2 480 288 480s145.5-36.8 192.6-80.6c46.8-43.5 78.1-95.4 93-131.1 3.3-7.9 3.3-16.7 0-24.6-14.9-35.7-46.2-87.7-93-131.1C433.5 68.8 368.8 32 288 32zm-96 224a96 96 0 1 1 192 0 96 96 0 1 1-192 0zm224 0a128 128 0 1 0-256 0 128 128 0 1 0 256 0z">`);
const Eye = (props = {}) => (() => {
  var _el$ = _tmpl$$7();
  spread(_el$, props, true, true);
  return _el$;
...
var _tmpl$$6 = /*#__PURE__*/template(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 640 512"><path d="M25.9 3.4C19-2 8.9-.8 3.4 6.1s-4.2 17 2.7 22.5l608 480c6.9 5.5 17 4.3 22.5-2.6s4.3-17-2.6-22.5L25.9 3.4zm579.6 264.9c3.3-7.9 3.3-16.7 0-24.6-14.9-35.7-46.2-87.7-93-131.1C465.5 68.8 400.8 32 320 32c-51.2 0-96 14.8-133.9 36.8l27.3 21.5C244.6 74.2 280.2 64 320 64c70.4 0 127.7 32 170.8 72 43.1 40 71.9 88 85.2 120-9.2 22.1-25.9 52-49.5 81.5l25.1 19.8c25.6-32 43.7-64.4 53.9-89zM88.4 154.7c-25.6 32-43.7 64.4-53.9 89-3.3 7.9-3.3 16.7 0 24.6 14.9 35.7 46.2 87.7 93 131.1 47 43.8 111.7 80.6 192.5 80.6 51.2 0 96-14.8 133.9-36.8l-27.3-21.5C395.4 437.8 359.8 448 320 448c-70.4 0-127.7-32-170.8-72-43.1-40-71.9-88-85.2-120 9.2-22.1 25.9-52 49.5-81.5l-25.1-19.8zM320 384c16.7 0 32.7-3.2 47.4-9.1l-30.9-24.4c-5.4.9-10.9 1.4-16.5 1.4-51 0-92.8-39.8-95.8-90.1l-30.9-24.4c-.9 6-1.3 12.2-1.3 18.5 0 70.7 57.3 128 128 128zm128-128c0-70.7-57.3-128-128-128-16.7 0-32.7 3.2-47.4 9.1l30.9 24.4c5.4-.9 10.9-1.4 16.5-1.4 51 0 92.8 39.8 95.8 90.1l30.9 24.4c.9-6 1.3-12.2 1.3-18.5z">`);
...
var _tmpl$$5 = /* @__PURE__ */ template(`<input type=text class=focussed placeholder="Enter custom url or blank for agent website."style=width:275px>`), _tmpl$2$3 = /* @__PURE__ */ template(`<tr><td></td><td><input class=focussed placeholder="Override name"></td><td style=text-transform:capitalize></td><td></td><td></td><td></td><td class=actions>`), _tmpl$3 = /* @__PURE__ */ template(`<span style=opacity:0.2>-`), _tmpl$4 = /* @__PURE__ */ template(`<select aria-label="Landing Pages"class=focussed><option value=0>`), _tmpl$5 = /* @__PURE__ */ template(`<option>`);
const Asset = (props) => {
  const asset = app.store.allAssets[`${props.asset.folder}/${props.asset.stylesheet}`];
  console.log("@", asset);
  return createComponent(Show, {
    when: asset,
    get children() {
      var _el$ = _tmpl$2$3(), _el$2 = _el$.firstChild, _el$3 = _el$2.nextSibling, _el$4 = _el$3.firstChild, _el$5 = _el$3.nextSibling, _el$6 = _el$5.nextSibling, _el$7 = _el$6.nextSibling, _el$8 = _el$7.nextSibling, _el$0 = _el$8.nextSibling;
      insert(_el$2, () => asset.name);
      _el$4.addEventListener("change", (e) => props.update({
        ...props.asset,
        name: e.target.value
      }));
      insert(_el$5, () => props.asset.folder.replaceAll("-", " "));
      insert(_el$6, () => asset.supports);
      insert(_el$7, createComponent(Show, {
        get when() {
          return asset.sizes == "Landing Page";
        },
        get fallback() {
          return _tmpl$3();
        },
        get children() {
          return createComponent(LandingPages, {
            onChange: (value) => props.update({
              ...props.asset,
              lpo: value
            }),
            defaultCaption: "None (will be rendered)",
            get current() {
              return props.asset.lpo;
            },
            get actual() {
              return props.asset.stylesheet;
            }
          });
        }
      }));
      insert(_el$8, createComponent(Show, {
        get when() {
          return asset.supports.includes("QRCode");
        },
        get fallback() {
          return _tmpl$3();
        },
        get children() {
          return [createComponent(LandingPages, {
            ...
            get current() {
              return props.asset.qrUrl;
            }
          }), createComponent(Show, {
            get when() {
              return !props.asset?.qrUrl || parseInt(props.asset?.qrUrl) == 0;
            },
            get children() {
              var _el$9 = _tmpl$$5();
              _el$9.addEventListener("change", (e) => props.update({
                ...props.asset,
                qrDestination: e.target.value
              }));
              createRenderEffect(() => _el$9.value = props.asset?.qrDestination ?? "");
              return _el$9;
            }
          })];
        }
      ...
      insert(_el$0, createComponent(Show, {
        ...
        get children() {
          return createComponent(Down, {
            style: "fill:var(--genie-primary);",
            onClick: () => props.moveDown()
          });
        }
      }), null);
      insert(_el$0, createComponent(Trash, {
        style: "fill:var(--genie-primary);",
      ...
      insert(_el$0, createComponent(Switch, {
        get children() {
          return [createComponent(Match, {
            get when() {
              return props.asset.hide;
            },
            get children() {
              return createComponent(EyeSlash, {
      ...
      createRenderEffect(() => _el$4.value = props.asset.name || asset.knownAs || "");
      return _el$;
    }
  });
};
const LandingPages = (props) => (() => {
  ...
  _el$11.addEventListener("change", (e) => props.onChange(e.target.value !== "0" ? e.target.value : null));
  insert(_el$12, () => props.defaultCaption);
  insert(_el$11, createComponent(For, {
    get each() {
      return app.currentLandingPages(props.incLPOs);
    },
    children: (lp) => lp !== props.actual && (() => {
      var _el$13 = _tmpl$5();
      insert(_el$13, lp);
      createRenderEffect(() => _el$13.selected = props.current == lp);
      return _el$13;
    })()
  }), null);
  return _el$11;
...
var _tmpl$$3 = /* @__PURE__ */ template(`<tr><td><select aria-label=Assets></select></td><td colspan=3 class=actions>`), _tmpl$2$2 = /* @__PURE__ */ template(`<option>`);
  ...
  return (() => {
    ...
    insert(_el$3, createComponent(For, {
      ...
      children: (key) => (() => {
        var _el$5 = _tmpl$2$2();
        _el$5.value = key;
        insert(_el$5, () => app.store.allAssets[key].name);
        return _el$5;
      })()
    }));
    insert(_el$4, createComponent(Plus, {
      style: "fill:var(--genie-primary);",
...
var _tmpl$$2 = /* @__PURE__ */ template(`<thead style=text-align:left><tr><th>Asset Name</th><th>Name Override</th><th>Type</th><th>Supports</th><th>LPO for</th><th>QR Destination</th><th>`), _tmpl$2$1 = /* @__PURE__ */ template(`<div class=collection-box><div class=input-grid><span>Section Name:</span><input class=focussed placeholder="Section Name"type=text><span>Section Caption:</span><input class=focussed type=text><span style=align-self:baseline>Section Description:</span><textarea class=focussed></textarea></div><h3>Assets</h3><table style=width:100%><tbody></tbody></table><div class=flex-row style=margin-top:2rem><button type=button>Remove <strong>`);
const Section = (props) => {
  ...
  const addAsset = (newAsset) => {
    let newAssets = isIterable(props.section?.assets) ? [...props.section.assets] : [];
  ...
  return (() => {
    var _el$ = _tmpl$2$1(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.nextSibling, _el$5 = _el$4.nextSibling, _el$6 = _el$5.nextSibling, _el$7 = _el$6.nextSibling, _el$8 = _el$7.nextSibling, _el$9 = _el$2.nextSibling, _el$0 = _el$9.nextSibling, _el$10 = _el$0.firstChild, _el$11 = _el$0.nextSibling, _el$12 = _el$11.firstChild, _el$13 = _el$12.firstChild, _el$14 = _el$13.nextSibling;
    _el$4.addEventListener("change", (e) => props.updateName(e.target.value));
    _el$6.addEventListener("change", (e) => props.update({
      ...props.section,
      meta: {
        ...props.section.meta,
    ...
    _el$8.addEventListener("change", (e) => props.update({
      ...props.section,
      meta: {
        ...props.section.meta,
    ...
    insert(_el$8, () => props.section.meta?.description ?? "");
    insert(_el$0, createComponent(Show, {
      get when() {
        return props.section?.assets?.length > 0;
      },
      get children() {
        return _tmpl$$2();
      }
    ...
    insert(_el$10, createComponent(For, {
      get each() {
        return props.section.assets;
      },
      children: (item, index) => createComponent(Asset, {
        asset: item,
        index,
        get count() {
          return props.section.assets.length;
        },
    ...
    insert(_el$10, createComponent(NewAsset, {
      get currentAssets() {
        return props.section.assets;
      },
      addAsset
    }), null);
    _el$12.$$click = () => props.removeSection();
    insert(_el$14, () => props.name);
    createRenderEffect(() => _el$4.value = props.name);
    createRenderEffect(() => _el$6.value = props.section.meta?.caption ?? "");
    return _el$;
  })();
};
delegateEvents(["click"]);
...
var _tmpl$ = /* @__PURE__ */ template(`<div style=background-color:var(--genie-background);color:var(--genie-white)><span style=float:right;font-size:75%;font-weight:bold;margin:1rem></span><h1 style=margin:0;padding:2rem;display:flex;align-items:center>Genie Collection Editor`), _tmpl$2 = /* @__PURE__ */ template(`<main style=margin:4rem>`);
function App() {
  return [(() => {
    ...
    insert(_el$3, createComponent(Show, {
      ...
      get children() {
        return [" - ", " ", memo(() => app.currentCollection()?.name)];
      }
    }), null);
    return _el$;
  })(), (() => {
    ...
    insert(_el$5, createComponent(Show, {
      ...
      get children() {
        return createComponent(Collections, {});
      }
    }), null);
    insert(_el$5, createComponent(Show, {
      get when() {
      ...
      get children() {
        return createComponent(Collection, {
          get index() {
            return app.store.collectionIndex;
          }
        });
      }
    }), null);
