...
const scriptRel = 'modulepreload';const assetsURL = function(dep, importerUrl) { return dep[0] === '.' ? new URL(dep, importerUrl).href : dep };const seen = {};const __vitePreload = function preload(baseModule, deps, importerUrl) {
...
const genericJS = () => {
  ...
  if (document.querySelectorAll("div.genie-embed").length > 0) {
    ...
    div.id = "genie-embeds";
    document.body.appendChild(div);
    const Genies = lazy(() => __vitePreload(() => import('./_Genies.js'),true?[window.gHub.buildUrl("assets/_Genies.js"),window.gHub.buildUrl("assets/index2.js"),window.gHub.buildUrl("assets/index.css")]:void 0,import.meta.url));
