...
import { a as useSettings, C as Context4Settings, g as usePagination, h as listingsStore, i as filterListings, j as unwrap, k as sharedEmbedStore, b as areaDataStore, p as percent } from './index2.js';
...
const FastFacts = (() => {
  ...
  return [createComponent(Editable, {
    ...
    insert(_el$5, createComponent(ListingTableLinks, {
      ...
      showProperties: (propertyTypeID, statusType) => showProperties(propertyTypeID, statusType)
    }), null);
    ...
    insert(_el$30, createComponent(Show, {
      ...
      get children() {
        return [(() => {
          ...
          _el$31.$$click = () => areaDataStore.propertyStats[props.status] > 0 && props.showProperties(props.propertyView, props.status);
