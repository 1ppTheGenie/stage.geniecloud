import { $ as $PROXY, p as $TRACK, q as getListener, v as batch, c as createSignal, w as createRoot, j as createResource, a as createEffect, o as onMount, x as createContext } from './index.js';
...
const defaultPropertyType = Math.max(
	parseInt(
		(typeof window.gHub !== "undefined" && window.gHub.propertyType) || 0,
		10
	),
	0
);
...
const defaultPeriod = parseInt(
	typeof window.gHub !== "undefined" ? window.gHub.areaPeriod ?? 6 : 6,
	10
);
...
const Context4Settings = createContext();
