...
const MarketRadar = (() => {
  return [_tmpl$(), (() => {
    ...
    insert(_el$5, createComponent(MRIcon, {
      icon: "line-chart",
      get value() {
        return window.gHub.currency(stats.avgListPriceForSold);
      },
    ...
    insert(_el$5, createComponent(MRIcon, {
      icon: "ruler",
      get value() {
        return window.gHub.currency(stats.avgPricePerSqFt);
      },
    ...
    insert(_el$5, createComponent(MRIcon, {
      icon: "bar-chart",
      get value() {
        return window.gHub.currency(stats.maxSale.salePrice);
      },
    ...
    insert(_el$5, createComponent(MRIcon, {
      icon: "bar-chart",
      get value() {
        return window.gHub.currency(stats.avgSalePrice);
      },
    ...
    insert(_el$5, createComponent(MRIcon, {
      icon: "bar-chart",
      get value() {
        return window.gHub.currency(stats.medSalePrice);
      },
    ...
    insert(_el$5, createComponent(MRIcon, {
      icon: "bar-chart",
      get value() {
        return window.gHub.currency(stats.minSale.salePrice);
      },
