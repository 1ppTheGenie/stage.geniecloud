...
const LineChart = props => {
	...
	return createMemo(
		(() => {
			...
			return () =>
				_c$() && genieCharts.draw("90%", "70%", props.data, props.element);
		})()
	);
};
const loadCharts = () =>
	new Promise(resolve => {
		if (!document.getElementById("genie-charts")) {
			...
			script.onload = () => {
				...
				gScript.onload = () => {
					genieCharts = window.gHub.initCharts();
					resolve(true);
				};
...
const _tmpl$ = /*#__PURE__*/ template(`<h1>A History of the<br>&#160;Market`),
	_tmpl$2 = /*#__PURE__*/ template(
		`<div class="curved-tabs"><span>Price per sq/ft</span><span>Price history</span><span>Sales history`
	),
