import { c as createSignal, i as insert, b as createComponent, F as For, s as setAttribute, e as createRenderEffect, f as style, g as createMemo, S as Show, t as template } from './index.js';
...
const _tmpl$$1 = /*#__PURE__*/template(`<div class="flex-row"><div class="w-66"><div class="listDetail"><table id="listing-table" class="active-table" style=" font-size:80%;"><thead><tr></tr></thead><tbody>`),
...
const MapListings = props => {
  ...
  return (() => {
    ...
    insert(_el$6, () => headings.map((caption, i) => (() => {
      const _el$8 = _tmpl$2$1();
      setAttribute(_el$8, "key", i);
      setAttribute(_el$8, "title", caption === "BR" ? "Bedrooms" : caption === "BA" ? "Bathrooms" : "");
      insert(_el$8, caption);
      createRenderEffect(_$p => style(_el$8, i === 0 ? {
        textAlign: "left"
      } : null, _$p));
      return _el$8;
    })()));
      ...
      get children() {
        return createComponent(For, {
          ...
          children: l => (() => {
            ...
            insert(_el$10, () => address(l));
            insert(_el$11, () => l.bedrooms);
            insert(_el$12, () => l.bathroomsTotal);
            insert(_el$13, () => Intl.NumberFormat("en-US").format(l.sqft));
            insert(_el$14, () => currency(l.priceHigh));
            insert(_el$15, () => currency(l.salePrice));
            insert(_el$16, (() => {
      ...
      get children() {
        return createComponent(For, {
          ...
          children: l => (() => {
            ...
            insert(_el$20, () => address(l));
            insert(_el$21, () => currency(l.priceHigh));
            insert(_el$22, () => l.bedrooms);
            insert(_el$23, () => l.bathroomsTotal);
            insert(_el$24, () => format(Date.parse(l.listDate), "M-d-y"));
            insert(_el$25, (() => {
