...
const MarketReportTiles = (() => {
  return [(() => {
    ...
    insert(_el$16, () => window.gg.currency(stats.avgListPriceForSold));
    insert(_el$19, () => window.gg.currency(stats.avgPricePerSqFt));
    insert(_el$22, () => window.gg.currency(stats.medSalePrice));
    insert(_el$24, period, _el$25);
    insert(_el$26, () => window.gg.percent(stats.turnOver));
    insert(_el$29, () => window.gg.currency(stats.avgSalePrice));
    insert(_el$32, () => window.gg.percent(stats.avgSalePrice / stats.avgListPriceForSold));
    insert(_el$35, () => stats.taxroll);
    insert(_el$38, () => window.gg.percent(stats.ownerOccupancy));
    return _el$4;
  })()];
});
