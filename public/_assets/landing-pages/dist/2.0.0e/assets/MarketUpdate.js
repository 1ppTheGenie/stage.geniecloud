import { z as spread, t as template, i as insert, b as createComponent, S as Show } from './index.js';
import { r as requiredArgs, t as toDate, _ as _typeof, a as useSettings, b as areaDataStore, p as percent, c as currency, n as getCssVar } from './index2.js';
...
const MarketUpdate = (() => {
  ...
  return (() => {
    ...
    insert(_el$12, () => areaDataStore.propertyTypeCaption);
    insert(_el$2, createComponent(Show, {
      ...
      get children() {
        return [(() => {
          ...
          insert(_el$13, () => currency(areaDataStore.propertyStats.maxSale.salePrice), _el$14);
          insert(_el$14, () => `Sold on ${format(new Date(areaDataStore.propertyStats.maxSale.soldOn), "MMMM d, Y")}`);
          return _el$13;
          ...
          get children() {
            ...
            insert(_el$19, () => areaDataStore.propertyTypeCaption);
            insert(_el$20, () => currency(areaDataStore.propertyStats.avgSalePrice));
            insert(_el$21, createComponent(Arrow, {
              get style() {
            ...
            insert(_el$21, () => `${areaDataStore.percentChange > 0 ? "Up" : "down"} ${percent(Math.abs(areaDataStore.percentChange))} since `, _el$22);
            insert(_el$21, () => `${format(sub(new Date(), {
          ...
          get children() {
            return [(() => {
              ...
              insert(_el$26, () => areaDataStore.propertyTypeCaption);
              return _el$23;
            })(), (() => {
              const _el$27 = _tmpl$4();
              insert(_el$27, () => currency(areaDataStore.propertyStats.medSalePrice));
              return _el$27;
            })()];
          }
        })];
    ...
    insert(_el$28, createComponent(LeafletMap, {
