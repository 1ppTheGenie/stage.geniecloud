<?xml version="1.0"?>
<!--
	Asset Name: Direct Mail Postage Side - No.5
	Tags: 		Open House
	Sizes:		Postcard
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template name="svg-body">
		<image width="50%" height="100%" preserveAspectRatio="xMidYMid slice">
			<xsl:call-template name="switch-image">
				...
				<xsl:with-param name="default" select="concat( //output/@siteUrl, '_assets/_img/front-05.jpg' )" />
			</xsl:call-template>
		</image>
	...
	<xsl:template name="cropped-content">
		...
		<text x="25%" y="82%" class="center large" fill="var(--theme-body-background)" style="font-weight:600; font-size:180%;">
		...
		<text x="25%" y="90%" class="medium center capitalize" fill="var(--theme-body-background)" style="font-weight:600; font-size:200%;">
			<xsl:value-of select="concat( 'market insider update - ', genie:format-date( //output/@reportDate, '[MNn] [Y0001]') )" />
		</text>
