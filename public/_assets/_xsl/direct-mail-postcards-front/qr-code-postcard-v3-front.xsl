<?xml version="1.0"?>
<!--
	Asset Name:	Qr Code Postcard v3 Front 
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.1" expand-text="yes">
	...
	<xsl:template name="svg-body">
		...
		<rect x="0%" y="0%" fill-opacity="1" width="100%" height="67%" opacity="0.5" fill="var(--theme-heading-color)"/>
	...
	<xsl:template name="cropped-content">
		...
		<g style="transform:translate(1%,57%)">
			...
			<svg height="18%" width="18%">
				...
				<use href="{concat( //output/@siteUrl, '_assets/_img/icons.svg#arrow-right-up' )}" x="20.2%" y="19.5%" width="60%" height="60%" stroke="var(--theme-sub-heading-color)" fill="none" />
			</svg>
		</g>
		...
		<g style="transform:translate(41.3%,62%)">
			<use href="{concat( //output/@siteUrl, '_assets/_img/icons.svg#arrow-up-bg' )}" width="10%" height="20%" stroke="var(--theme-sub-heading-color)" fill="var(--theme-sub-heading-color)"/>
