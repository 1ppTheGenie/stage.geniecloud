<?xml version="1.0"?>
<!--
	Asset Name: Direct Mail Postage Side - No.4
	Tags: 		Open House
	Sizes:		Postcard
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.0" expand-text="yes">
	...
	<xsl:template name="svg-body">
		...
		<rect x="0" y="80%" width="50%" height="7%" fill="var(--theme-sub-heading-color)" />
		<rect x="0" y="88%" width="50%" height="7%" fill="var(--theme-sub-heading-color)" />

		<xsl:call-template name="cropped-container" />
	</xsl:template>
	<xsl:template name="cropped-content">

		<text x="25%" y="81%" class="center narrow" fill="var(--theme-body-background)" style="font-size:130%;">
		...
		<text x="25%" y="90%" class="center upper narrow" fill="var(--theme-body-background)" style="font-size:130%;">
			<xsl:call-template name="editable">
