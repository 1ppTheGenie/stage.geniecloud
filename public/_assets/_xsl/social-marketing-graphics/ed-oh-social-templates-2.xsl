...
<xsl:attribute name="href" select="concat( //output/@siteUrl, '_assets/_css/futura-embedded.css')" />
		...
		<foreignObject x="-1%" y="-5%" height="22%" width="54%" style="transform-origin: 0; transform: rotate(-90deg) translate(-7%, 63%)">
			<div>
				<h2 class="upper" style="color:var(--theme-heading-color); font-weight:500;  font-size:2.5rem; font-family:var(--theme-heading-font)">
...
<rect fill="#e3e3e3" stroke-width="1%" stroke="#fff" fill-opacity="1" x="2%" y="61.5%" width="34%" height="33%" />
		...
		<text font-family="var(--theme-heading-font)" x="40.8%" y="78.8%" fill="var(--theme-heading-color)" font-weight="800" font-size="3rem">
			<xsl:text>Open 1-4pm</xsl:text>
		</text>

		<text font-family="var(--theme-heading-font)" x="40.8%" y="85.5%" fill="var(--theme-heading-color)" font-weight="400" font-size="3rem" data-max-width="55%" style="letter-spacing:-1px;">
