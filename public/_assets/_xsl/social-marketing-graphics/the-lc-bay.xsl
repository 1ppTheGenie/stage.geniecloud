...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.0" expand-text="yes">
	...
	<xsl:template name="svg-body">
		...
		<style>
			<xsl:value-of select="'
            .gotham-font{ font-family: &quot;gotham&quot; !important; }
            .raleway{ font-family: &quot;Raleway&quot;, sans-serif; }
            g#footer{ font-size:35%; transform:translate(2.5%,98.5%);}
		...
		<text class="upper center middle raleway" x="18%" y="12%" font-size="140%" font-weight="500" fill="#ffffff">
			<xsl:choose>
		...
		<text class="upper center middle raleway" x="18%" y="16.5%" font-size="140%" font-weight="500" fill="#ffffff">
			<xsl:choose>
		...
		<line stroke="var(--theme-heading-color)" stroke-width="1" x1="0%" y1="80%" x2="100%" y2="80%"/>

		<!-- <image x="5%" y="87%" width="39%" height="11%" preserveAspectRatio="xMinYMid meet">
		...
		<xsl:choose>
			<xsl:when test="$companyLogo='' or $personalLogo=''">
				<image x="3%" y="86%" width="34%" height="12%" id="logo" preserveAspectRatio="xMidYMid meet">
					<xsl:attribute name="href">
						<xsl:choose>
			...
			<xsl:otherwise>
				<image x="3.1%" y="86%" width="30%" height="12%" class="center" preserveAspectRatio="xMidYMid meet">
					<xsl:attribute name="href">
						<xsl:value-of select="$personalLogoInverse" />
					</xsl:attribute>
				</image>
				<image x="36%" y="86.5%" width="10%" height="12%" class="center" preserveAspectRatio="xMidYMid meet">
					<xsl:attribute name="href">
						<xsl:value-of select="$companyLogoInverse" />
					</xsl:attribute>
				</image>
		...
		<text x="95%" y="85%" class="align-right gotham-font" fill="var(--theme-sub-heading-color)" data-max-width="70%" font-weight="600" font-size="170%" letter-spacing="0.25">
			<tspan>
...
<xsl:text> &#124; </xsl:text>
		...
		<text x="95%" y="92%" class="upper center align-right gotham-font" fill="var(--theme-heading-color)" data-max-width="45%" font-weight="600" font-size="110%">
		...
		<text x="95%" y="95%" class="upper align-right gotham-font" fill="var(--theme-body-color)" data-max-width="33%" fill-opacity="0.75" font-weight="600" font-size="72.5%">
			<xsl:call-template name="editable">
