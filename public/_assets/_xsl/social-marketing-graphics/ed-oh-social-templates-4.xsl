...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.0" expand-text="yes">
  ...
  <xsl:template name="svg-body">
    ...
    <text class="capitalize" fill="var(--theme-heading-color)" font-family="var(--theme-heading-font)" x="3.8%" y="91%"
    ...
    <svg x="77%" y="78%" width="200" height="200">
      ...
      <image x="0" y="10" width="200" height="200" preserveAspectRatio="xMidYMid meet" clip-path="url(#clipCircle)">
        <xsl:attribute name="href">
