<?xml version="1.0"?>
<!--
	Asset Name:	Single Listing No.5
	...
	<xsl:template name="svg-body">
		...
		<g style="transform: translate(65%,76%);">
			<svg width="33%" height="17.5%">
				...
				<text x="37%" y="83%" style="font-size:90%">
		...
		<g style="transform:translate(1%,2%)">
			<xsl:choose>
				<xsl:when test="(number(//single/statusTypeID)=3) or (number(//single/statusTypeID)=4) or (number(//single/statusTypeID)=12)">
					<text x="1%" y="10%" style="dominant-baseline: alphabetic;" class="super-large bold" fill="var(--theme-sub-heading-color)">
						<tspan class="upper narrow">In</tspan>
						<xsl:text>&#160;</xsl:text>
						<tspan class="upper bold">Escrow
						</tspan>
					</text>
				</xsl:when>
				<xsl:when test="number(//single/statusTypeID)=2">
					<text x="1%" y="10%" style="dominant-baseline: alphabetic;" class="super-large bold" fill="var(--theme-sub-heading-color)">
						...
						<xsl:text>&#160;</xsl:text>
						<tspan class="upper bold">Sold
						</tspan>
					</text>
				</xsl:when>
				<xsl:when test="number(//single/statusTypeID)=14">
					<text x="1%" y="10%" style="dominant-baseline: alphabetic;" class="super-large bold" fill="var(--theme-sub-heading-color)">
						<tspan class="upper narrow">Coming</tspan>
						<xsl:text>&#160;</xsl:text>
						<tspan class="upper bold">Soon
						</tspan>
					</text>
				</xsl:when>
				<xsl:otherwise>
			...
			<text x="1%" y="30%" class="medium upper bold" fill="var(--theme-sub-heading-color)" style="dominant-baseline: alphabetic;">
