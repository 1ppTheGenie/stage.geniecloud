...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.0" expand-text="yes">
	...
	<xsl:template name="svg-body">
		...
		<g style="transform: translate(0%,4%);">
			...
			<text class="sub-heading large bold" style="transform:translate(8%,36%)">
		...
		<foreignObject x="2%" y="53%" width="62%" height="25%">
		...
		<g style="transform:translate(1%,79%)">
			<svg width="35%" height="17.5%">
				<xsl:call-template name="agent-box-style">
					<xsl:with-param name="circle-image" select="'no'" />
				</xsl:call-template>
				<text x="25%" y="85%" class="bold" style="font-size:80%" fill="var(--theme-body-color)">
