										...
										<div class="phone-btn mail-icon">
											<a>
												...
												<svg version="3.0" id="Capa_1"
													...
													xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="469.2px" height="469.2px" viewBox="0 0 469.2 469.2" style="enable-background:new 0 0 469.2 469.2;" xml:space="preserve" fill="var(--theme-heading-color)">
													<g>
