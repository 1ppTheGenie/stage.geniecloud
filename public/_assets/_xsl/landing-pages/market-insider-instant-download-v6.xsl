										...
										<xsl:choose>
											<xsl:when test="$change > 0">
												<svg fill="var(--active-green)" viewBox="0 0 490.667 490.667">
                                                   ...
                                                   c4.16,4.16,10.923,4.16,15.083,0l77.781-77.781l77.781,77.803c2.091,2.069,4.821,3.115,7.552,3.115c2.731,0,5.461-1.045,7.552-3.136C342.379,206.037,342.379,199.275,338.219,195.115z"/>
												</svg>
											</xsl:when>
											<xsl:otherwise>
