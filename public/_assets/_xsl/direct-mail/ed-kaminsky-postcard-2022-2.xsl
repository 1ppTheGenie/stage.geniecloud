...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.0" expand-text="yes">
	...
	<xsl:template name="cropped-content">
		...
		<text x="4%" y="85%" class="bold" font-size="115%" font-family="var(--theme-body-font)" fill="#ffffff" data-max-width="11%">
			<tspan>
				<xsl:call-template name="editable">
		...
		<text x="75%" y="88%" data-max-width="30%" class="center upper" fill="#ffffff" font-family="var(--theme-body-font)" font-size="135%" font-weight="600" style="text-shadow: 1px 1px 2px #0e1232;">
			<tspan>
