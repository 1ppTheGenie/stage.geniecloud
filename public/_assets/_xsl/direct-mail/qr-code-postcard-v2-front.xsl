...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.0" expand-text="yes">
	...
	<xsl:template name="svg-body">
		...
		<g style="transform:translate(50%,2%)">
		...
		<image x="37.5%" y="21%" width="25%" height="40%" preserveAspectRatio="xMidYMid meet">
			<xsl:attribute name="href">
				<xsl:value-of select="concat( //output/@siteUrl, '_assets/_img/chart.png' )" />
			</xsl:attribute>
		</image>

		<g style="transform:translate(1%,57%)">
			<svg height="18%" width="18%" y="1.8%">
				<circle cx="50%" cy="50%" r="30%" opacity="0.5" fill="var(--theme-body-color)" />
			</svg>
