...
<xsl:import href="common.xsl" />
	...
	<xsl:template name="cropped-content">
		<text x="20%" y="2%" class="center upper " fill="var(--theme-heading-color)" style="font-size:450%;font-weight: 600;font-family: Lato;">
...
<rect x="0.5%" y="50%" width="67%" height="12%" fill="var(--theme-body-color)" />
		...
		<text x="35%" y="70%" class="upper" style="font-weight:600;font-size:150%;font-family:Helvetica,Arial,sans-serif;" fill="var(--theme-heading-color)">
			<xsl:call-template name="editable">
		...
		<g style="transform:translate(1%,17%)">
			<svg x="1%" y="0%" width="65%" height="15%">
				<text class="upper" fill="var(--theme-heading-color)" style="font-size:200%;line-height:140%;font-family: Lato;color:var(--theme-heading-color);">
...
<xsl:call-template name="listing-address-line-one" />
			...
			<svg x="2%" y="17.5%" width="95%" height="20%" fill="var(--theme-heading-color)" style="color:var(--theme-heading-color)">
				<text class="upper" style="font-weight:600;font-size:450%;font-family: Lato;">
					<tspan >...And I'm happy to share</tspan>
				</text>
			</svg>
		</g>
		<g style="transform-origin: 0; transform: rotate(-90deg) translate(-25%, 56%);">
			<text x="0%" y="0%" class="upper bold" fill="var(--theme-body-background)" style="font-size:125%;letter-spacing: 2px;font-family: Lato;">
				<xsl:call-template name="editable">
		...
		<g style="transform:translate(6%,62%)">
			<text x="3%" y="0%" class="upper center bold" fill="var(--theme-body-background)" style="font-size:620%;font-family: Lato;">
				<xsl:call-template name="editable">
		...
		<g style="transform:translate(5%,80%)">
			<svg x="1%" y="0%" width="10%" height="20%" fill="var(--theme-body-background)" style="color:var(--theme-body-background)">
				<text class="upper center bold" style="font-size:200%;font-family: Lato;">
					<tspan x="30%">
						<xsl:call-template name="editable">
		...
		<g style="transform:translate(52.3%,78%)">
			...
			<text x="1.5%" y="2.3%" class="upper bold" fill="var(--theme-body-background)" style="font-size:125%;font-family: Lato;">
				<xsl:call-template name="editable">
