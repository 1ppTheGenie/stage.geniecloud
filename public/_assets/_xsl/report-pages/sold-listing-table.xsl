...
<xsl:value-of select="'text { dominant-baseline: middle;}'" />
		...
		<g style="transform:translateY(28%)">
			<rect style="fill:var(--sold-red);stroke:var(--sold-red);" x="2%" y="-0.8%" width="96%" height="6%" />

			<text y="2.4%" fill="#fff">
				<tspan x="3%" class="bold">Address</tspan>
				<tspan x="43%" class="align-center bold">BR</tspan>
				<tspan x="48%" class="align-center bold">BA</tspan>
				<tspan x="55%" class="align-center bold">Sq Ft</tspan>
				<tspan x="66%" class="align-center bold">List Price</tspan>
				<tspan x="78%" class="align-center bold">Sold Price</tspan>
				<tspan x="90%" class="align-center bold">Sold Date</tspan>
			</text>
