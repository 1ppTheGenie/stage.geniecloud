<?xml version="1.0"?>
<!--
	Asset Name:	What People Are Buying - By Bedroom
	Tags:		Infographic
	Supports:	Area
	Sizes:		Facebook
-->
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.0" expand-text="yes">
	...
	<xsl:template name="svg-body">
		...
		<text x="50%" y="9%" class="upper center sub-heading" style="fill: var(--theme-sub-heading-color);font-size:180%;">
		...
		<text x="50%" y="18%" class="upper center heading" style="font-size: 300%;">look at what people are buying</text>

		<text x="50%" y="26%" class="medium center" font-family="var(--theme-body-font)" fill="var(--theme-body-color)">
			<tspan>
				...
				<g>
					...
					<g style="transform: translateX(6.5%);">
						...
						<xsl:if test="@sold &gt; 0">
							...
							<text y="3.5%" style="font-size:130%;">
								<xsl:choose>
