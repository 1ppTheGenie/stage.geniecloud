<?xml version="1.0"?>
<!--
	Asset Name:	Listing Thumbnails - Sold
	Tags:		Thumbnails
...
<circle cx="1.5%" cy="2.5%" r="1%" fill="var(--sold-red)" fill-opacity="0.75" />
						...
						<polygon points="55,0 85,0 0,85 0,55" fill="var(--sold-red)" fill-opacity="0.75" />
						...
						<text class="align-right upper" x="22%" y="3%" fill="#fff">Sold Price</text>
