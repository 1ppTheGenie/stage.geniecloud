...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.0" expand-text="yes">
	...
	<xsl:template name="svg-body">
		...
		<text x="50%" y="41%" class="center upper bold" style="font-size:250%;fill:var(--theme-body-background);font-weight: 900;">
			<xsl:call-template name="editable">
				<xsl:with-param name="id" select="'TextorCall1'" />
				<xsl:with-param name="default" select="concat( 'text or call ', $agentMeUs )"/>
			</xsl:call-template>
		</text>

		<text x="50%" y="50%" class="capitalize center" style="font-size:260%;fill:var(--theme-body-background);">
			<xsl:call-template name="editable">
