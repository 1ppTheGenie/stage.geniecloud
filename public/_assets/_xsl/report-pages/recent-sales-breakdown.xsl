			...
			<g style="transform: translateY(10%)">
				<xsl:call-template name="lozenge">
					...
					<xsl:with-param name="caption">
						<tspan x="0">
							<xsl:value-of select="//statistics/byValue/range[1]/@value" />
						</tspan>
						<tspan x="0" dy="3.5%">
			...
			<g style="transform: translateY(30%)">
				<xsl:call-template name="lozenge">
					...
					<xsl:with-param name="caption">
						...
						<tspan x="0" dy="3.5%">
							<xsl:value-of select="concat( 'To ', //statistics/byValue/range[3]/@value )" />
						</tspan>
					</xsl:with-param>
...
<xsl:with-param name="value" select="concat( //statistics/byValue/range[2]/@sold, ' sales' )" />
			...
			<g style="transform: translateY(50%)">
				<xsl:call-template name="lozenge">
					...
					<xsl:with-param name="caption">
						<tspan x="0">
							<xsl:value-of select="//statistics/byValue/range[3]/@value" />
						</tspan>
						<tspan x="0" dy="3.5%">
