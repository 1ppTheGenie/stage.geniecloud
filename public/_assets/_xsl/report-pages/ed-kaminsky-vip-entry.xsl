...
<xsl:import href="common.xsl" />
	...
	<xsl:template name="svg-body">
		...
		<text x="50%" y="34%" class="upper center" fill="var(--theme-body-background)" font-family="var(--theme-heading-font)" font-size="1130%" font-weight="800" style="letter-spacing:2px">
		    VIP ENTRY 
		</text>
		<line x1="18%" y1="42.3%" x2="82%" y2="42.3%" stroke="var(--theme-emphasis-color)" stroke-width="0.2%" />

		<rect x="25%" y="41.2%" width="50.2%" height="2%" fill="var(--theme-body-color)" />

		<text x="50%" y="40.9%" class="center" font-family="var(--theme-sub-heading-font)" fill="var(--theme-body-background)" font-size="400%" font-weight="400" style="letter-spacing:5px;">
		    to your neighbor’s
		</text>
		<text x="50.5%" y="43.5%" class="upper center" font-family="var(--theme-heading-font)" fill="var(--theme-body-background)" font-size="856%" font-weight="400" style=" letter-spacing:10px;">
		    OPEN HOUSE 
		</text>
		...
		<text x="50%" y="65.6%" class="center" fill="var(--theme-body-background)" font-family="var(--theme-body-font)" font-size="385%" font-weight="800" style="letter-spacing:1px;">
		...
		<text x="50%" y="73.6%" class="center" fill="var(--theme-body-background)" font-family="var(--theme-body-font)" font-size="435%" font-weight="400" style="  letter-spacing:5px;">
		...
		<xsl:choose>
			<xsl:when test="$hasMultipleAgents">
				<text x="50%" y="76.7%" class="center" fill="var(--theme-body-background)" font-family="var(--theme-body-font)" font-size="243%" style="word-spacing: 5px;">
		...
		<xsl:choose>
			<xsl:when test="$hasMultipleAgents">
				...
				<svg x="20%" y="80%" width='180' height='180'>
					<circle cx="95" cy="95" r="85" stroke='var(--theme-body-background)' stroke-width='3' fill='#e3e3e3' />
				</svg>
				...
				<text x="0%" y="86.3%" font-family="var(--theme-body-font)" font-size="300%" font-weight="800" style="letter-spacing:2px">
					<tspan x="15.3%" dy="0%" fill="var(--theme-body-background)">
						<xsl:call-template name="editable">
				...
				<!-- license number -->
				<text x="15.3%" y="88.5%" fill="var(--theme-body-background)" font-family="var(--theme-body-font)" font-size="200%">
					<xsl:call-template name="editable">
				...
				<!-- contact detail -->
				<text x="15.3%" y="91.9%" fill="var(--theme-body-background)" font-family="var(--theme-body-font)" font-size="200%">
					<tspan x="15.3%" dy="0%" fill="var(--theme-body-background)" font-family="var(--theme-body-font)" font-weight="400">
						<xsl:call-template name="editable">
							<xsl:with-param name="default" select="concat(' ',//agent[1]/mobile)" />
						</xsl:call-template>
					</tspan>
					<tspan x="15.3%" dy="1.3%" fill="var(--theme-body-background)" font-family="var(--theme-body-font)" font-weight="400">
						<xsl:call-template name="editable">
				...
				<text x="95%" y="86.3%" font-family="var(--theme-body-font)" font-size="300%" font-weight="800" style="letter-spacing:2px">
					<tspan x="62%" dy="0%" fill="var(--theme-body-background)">
						<xsl:call-template name="editable">
				...
				<!-- license number -->
				<text x="62.3%" y="88.5%" fill="var(--theme-body-background)" font-family="var(--theme-body-font)" font-size="200%">
					<xsl:call-template name="editable">
						<xsl:with-param name="default" select="concat(' ',//agent[2]/marketingLicense)" />
					</xsl:call-template>
				</text>
				<!-- contact detail -->
				<text x="95.3%" y="91.9%" fill="var(--theme-body-background)" font-family="var(--theme-body-font)" font-size="200%">
					<tspan x="65.3%" dy="0%" fill="var(--theme-body-background)" font-family="var(--theme-body-font)" font-weight="400">
						<xsl:call-template name="editable">
							<xsl:with-param name="default" select="concat(' ',//agent[2]/mobile)" />
						</xsl:call-template>
					</tspan>
					<tspan x="65.3%" dy="1.3%" fill="var(--theme-body-background)" font-family="var(--theme-body-font)" font-weight="400">
						<xsl:call-template name="editable">
	...
	<xsl:template name="custom-agent-details">
		...
		<text x="%" y="82.4%" font-family="var(--theme-body-font)" font-size="300%" font-weight="800" style="letter-spacing:2px">
			<tspan x="32.3%" dy="0%" fill="var(--theme-body-background)">
				<xsl:call-template name="editable">
		...
		<text x="32.3%" y="84.2%" fill="var(--theme-body-background)" font-family="var(--theme-body-font)" font-size="200%">
			<xsl:call-template name="editable">
		...
		<text y="86.6%" font-family="var(--theme-body-font)" font-size="240%">
			...
			<tspan x="36.4%" dy="0%" fill="var(--theme-body-background)" font-family="var(--theme-body-font)" font-weight="400">
				<xsl:call-template name="editable">
		...
		<text y="89.7%" font-family="var(--theme-body-font)">
			...
			<tspan x="36.4%" dy="0%" fill="var(--theme-body-background)" font-family="var(--theme-body-font)" font-size="235%" font-weight="400">
				<xsl:call-template name="editable">
