<?xml version="1.0"?>
<!--
	Asset Name: Listing Ad No. 2
	Tags:		Listing
	Sizes:		Facebook Post, Facebook Ad, Instagram-Square
	Supports:	Facebook Post, Listing
-->
...
<xsl:import href="common.xsl" />
	...
	<xsl:template name="svg-body">
		<g style="transform: translateY(1%);">
			<text x="50%" class="super-large bold align-center sub-heading" style="font-size:220%">
					Just 
				<xsl:choose>
...
<rect width="49%" height="34%" style="fill:var(--theme-body-background);" />
				...
				<g class="upper bold" style="transform: translate( 13.5%, 35%);">
					<text y="0">
