...
<tspan> &#124; </tspan>
			...
			<foreignObject x="24%" y="8%" width="70%" height="10%" style='font-size: 140%;'>
				<p style="color:var(--theme-body-background);-webkit-line-clamp:3; line-height:150%">The information contained herein has been obtained through sources deemed reliable by Steve Hundley, but cannot be guaranteed for its accuracy. We recommend to the buyer that any information, which is of special interest, should be obtained through independent verification. ALL MEASUREMENTS ARE APPROXIMATE</p>
			</foreignObject>
		</g>
