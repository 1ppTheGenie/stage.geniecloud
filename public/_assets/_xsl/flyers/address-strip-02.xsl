        ...
        <g style="font-size: 14px">
            ...
            <g style="transform: translate(-4%, 4%)">
                <text font-family="var(--theme-heading-font)" fill="var(--theme-heading-color)" font-weight="800"
                    font-size="18em" class="upper" x="100%" text-anchor="end">
                    <xsl:value-of select="$listingAddressLine1" />
                </text>

                <xsl:choose>
                    <xsl:when test="count(//openHouse/session) &gt; 0">
                        <text font-family="var(--theme-heading-font)" x="100%" y="10%"
                            fill="var(--theme-sub-heading-color)" font-weight="800" font-size="18em" text-anchor="end">
                            Open House
                ...
                <svg width="900" x="3%" y="0%" height="700" viewBox="0 0 110 221" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <g transform="rotate(180, 55, 110.5)">
                        <path d="M110 110.5L0 220.5V0.5L110 110.5Z" fill="var(--theme-sub-heading-color)"></path>
                    </g>
                </svg>
            </g>
