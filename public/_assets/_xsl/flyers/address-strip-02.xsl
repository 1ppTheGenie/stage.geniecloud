        ...
        <g>
            ...
            <g style="transform: translate(-4%, 4%)">
                <text font-family="var(--theme-heading-font)" fill="#0f1132" font-weight="800"
                    font-size="85" class="upper" x="100%" text-anchor="end" data-max-width="80%">
                ...
                <xsl:choose>
                    <xsl:when test="count(//openHouse/session) &gt; 0">
                        <text font-family="var(--theme-heading-font)" x="100%" y="10%"
                            fill="#d2232a" font-weight="800" font-size="85" text-anchor="end">
                            Open House
                ...
                <svg width="120" x="8%" y="-39.5%" viewBox="0 0 110 221" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <g transform="rotate(180, 55, 110.5)">
                        <path d="M110 110.5L0 220.5V0.5L110 110.5Z" fill="#d2232a"></path>
                    </g>
                </svg>
            </g>
