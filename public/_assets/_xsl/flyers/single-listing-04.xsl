	...
	<xsl:template name="svg-body">
		...
		<g>
			...
			<g style="transform: translate(0%, 89%);">
				...
				<text x="30%" y="2.5%" class="theme-body" style="font-size: 180%;">
					<tspan>
						<xsl:call-template name="editable">
				...
				<text x="30%" y="4.6%" class="theme-body" style="font-size: 180%;" data-max-width="40%">
					<tspan>
						<xsl:call-template name="editable">
				...
				<text x="30%" y="6.5%" class="theme-body" style="font-size: 180%;" data-max-width="35%">
					<xsl:call-template name="editable">
						<xsl:with-param name="id" select="'agentwebsite'" />
						<xsl:with-param name="default" select="//agent[1]/website" />
					</xsl:call-template>
				</text>
				<text x="30%" y="8.5%" class="theme-body" style="font-size: 180%;">
					<tspan >
						<xsl:call-template name="editable">
