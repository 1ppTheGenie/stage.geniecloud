...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.0" expand-text="yes">
	...
	<xsl:template name="svg-body">
		...
		<g style="transform:translate(0%,43%)">
			...
			<text x="50%" y="0.5%" fill="var(--theme-body-background)" font-family="var(--theme-heading-font)" class="center upper" font-size="700%">
				<xsl:call-template name="editable">
					<xsl:with-param name="id" select="'openhouse'" />
			...
			<xsl:if test="count(//openHouse/session) &gt; 0">
				<text x="50%" y="8.5%" class="center middle bold" fill="var(--theme-body-background)" font-family="var(--theme-heading-font)" text-anchor="middle" font-size="340%" data-max-width="70%">
					<xsl:call-template name="editable">
