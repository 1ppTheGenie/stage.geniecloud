...
<xsl:attribute name="href" select="concat( //output/@siteUrl, '_assets/_css/futura-condensed.css')" />
		...
		<rect x="2%" y="2.5%" width="96%" height="97.5%" fill="var(--theme-body-background)" />
		...
		<text x="9.5%" y="48.3%" class="center" font-family="var(--theme-heading-font)">
			<tspan x="9.5%" dy="1%" font-size="36" font-weight="700" fill="var(--theme-body-color)">
				<xsl:value-of select="//single/bedrooms/@count" />
			</tspan>
			<tspan x="9.5%" dy="3.2%" class="center" font-family="var(--theme-heading-font)" fill="var(--theme-sub-heading-color)" font-size="25" font-weight="400">
		...
		<text x="9.5%" y="88.6%" class="center" font-family="var(--theme-heading-font)">
			<tspan x="9.5%" dy="1%" font-size="36" font-weight="700" fill="var(--theme-body-color)">$1,599,000</tspan>
			<tspan x="9.5%" dy="3.3%" fill="var(--theme-sub-heading-color)" font-size="25" font-weight="400">
				<xsl:value-of select="'Just Sold'" />
			</tspan>
		</text>

		<rect x="17%" y="2.5%" width="83%" height="98%" fill="var(--theme-heading-color)" />
		...
		<text x="20%" y="51%" fill="var(--theme-body-background)" font-family="var(--theme-heading-font)" font-size="40" font-weight="800">
		...
		<foreignObject width="50%" height="50%" x="20%" y="54.8%" font-family="var(--theme-heading-font)" style="color:var(--theme-body-background);font-size:21px; line-height:1.3; height:40%; font-family:var(--theme-heading-font)">
			<xsl:call-template name="editable">
		...
		<rect x="72.2%" y="2.5%" width="26%" height="98%" fill="var(--theme-heading-color)" />
		...
		<rect x="72.2%" y="73.2%" width="26%" height="24%" fill="var(--theme-body-background)" />
		<xsl:choose>
		...
		<g>
			<g>
				...
				<text x="81.8%" y="74.2%" class="super-bold" font-family="var(--theme-body-font)" font-size="200%">
					<tspan x="81.8%" y="74.2%" fill="var(--theme-heading-color)">
						<xsl:call-template name="editable">
				...
				<text x="81.8%" y="77%" fill="var(--theme-heading-color)" font-family="var(--theme-body-font)" font-size="120%">
					<xsl:call-template name="editable">
				...
				<text x="81.8%" y="78.7%" font-family="var(--theme-body-font)" font-size="120%">
					...
					<tspan dx=".3%" fill="var(--theme-heading-color)">
						<xsl:call-template name="editable">
		...
		<g>
			...
			<text x="81.8%" y="77.2%" fill="var(--theme-heading-color)" font-family="var(--theme-body-font)" font-size="140%">
				<xsl:call-template name="editable">
					<xsl:with-param name="id" select="'licenseno'" />
					<xsl:with-param name="default" select="//agent[1]/marketingLicense" />
				</xsl:call-template>
			</text>
			<line xmlns="" x1="82%" y1="80.5%" x2="96%" y2="80.5%" style="stroke:var(--theme-sub-heading-color);stroke-width:3.5"></line>
			...
			<text x="81.8%" y="84.7%" font-family="var(--theme-body-font)" font-size="140%">
				...
				<tspan dx="0.3%" fill="var(--theme-heading-color)">
					<xsl:call-template name="editable">
		...
		<text x="73.5%" y="88.8%" fill="var(--theme-heading-color)" font-family="var(--theme-body-font)" font-size="110%">
			<xsl:call-template name="editable">
		...
		<foreignObject width="23.5%" height="6.5%" x="73.5%" y="90.6%" font-family="var(--theme-heading-font)" font-size="100%" style="color:var(--theme-sub-heading-color);">
