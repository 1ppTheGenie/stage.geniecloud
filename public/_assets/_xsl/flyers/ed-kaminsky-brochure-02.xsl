...
<xsl:attribute name="href" select="concat( //output/@siteUrl, '_assets/_css/futura-condensed.css')" />
      ...
      <xsl:otherwise>
		...
		<text x="9.5%" y="88.6%" class="center" font-family="var(--theme-heading-font)">
			<tspan x="9.5%" dy="1%" font-size="36" font-weight="700" fill="var(--theme-body-background)">$1,599,000</tspan>
		...
		<text x="20%" y="51%" fill="var(--theme-heading-color)" font-family="var(--theme-heading-font)" font-size="40" font-weight="800">
		...
		<foreignObject width="50%" height="50%" x="20%" y="54.8%" font-family="var(--theme-heading-font)" style="color:var(--theme-heading-color);font-size:21px; line-height:1.3; height:40%; font-family:var(--theme-heading-font)">
			<xsl:call-template name="editable">
		...
		<g>
			<g>
				...
				<text x="81.8%" y="77%" fill="var(--theme-body-background)" font-family="var(--theme-body-font)" font-size="120%">
					<xsl:call-template name="editable">
		...
		<g>
			...
			<text x="81.8%" y="77.2%" fill="var(--theme-body-background)" font-family="var(--theme-body-font)" font-size="140%">
				<xsl:call-template name="editable">
					<xsl:with-param name="id" select="'licenseno'" />
					<xsl:with-param name="default" select="//agent[1]/marketingLicense" />
				</xsl:call-template>
