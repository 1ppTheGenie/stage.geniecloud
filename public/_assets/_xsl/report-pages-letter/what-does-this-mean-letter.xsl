<?xml version="1.0"?>
<!--
	Asset Name:	What does this mean to you letter?
	Tags:		Text
	Supports:	Area
	Sizes:		US Letter
-->
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.0" expand-text="yes">
	...
	<xsl:template name="svg-body">
		...
		<text x="50%" y="45%" class="h3 center" data-max-width="50%" font-size="250%" style="fill:var(--theme-body-background);">
			<xsl:call-template name="editable">
				<xsl:with-param name="id" select="'Whatdoes'" />
				<xsl:with-param name="default" select="'What does this'" />
			</xsl:call-template>
		</text>
		<text x="50%" y="49.5%" class="h3 center" data-max-width="50%" font-size="250%" style="fill:var(--theme-body-background);">
			<xsl:call-template name="editable">
