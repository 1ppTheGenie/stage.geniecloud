<?xml version="1.0"?>
<!--
	Asset Name: Map & Table with Pending Listings Letter
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.0" expand-text="yes">
	...
	<xsl:template name="svg-body">
		...
		<xsl:if test="$pendingListingCount = 0">
			...
			<rect xmlns="" x="7%" y="25%" rx="10" ry="10" width="85%" height="60%" fill-opacity="0" stroke-width="2" stroke="var(--pending-yellow)"></rect>
