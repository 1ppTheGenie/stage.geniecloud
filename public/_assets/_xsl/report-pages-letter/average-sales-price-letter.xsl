<?xml version="1.0"?>
<!--
	Asset Name: Average Sale Price Letter
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template name="svg-body">
		...
		<g style="transform:translateY(25%)">
			...
			<text x="50%" y="9%" class="align-center medium" font-family="var(--theme-heading-font)" style="fill:var(--theme-body-color)">
			...
			<text x="50%" y="41%" class="center sub-heading" style="font-size:134%;fill:var(--theme-sub-heading-color)">
				<tspan>
			...
			<text x="50%" y="45.5%" font-family="var(--theme-heading-font)" class="center bold medium" fill="var(--theme-body-color)">
