<?xml version="1.0"?>
<!--
	Asset Name:	Recent Sales Breakdown Letter
...
<xsl:import href="common.xsl" />
	...
	<xsl:template name="svg-body">
		<style>
			<xsl:value-of select="'.banner{ min-width:35%; }
		...
		<text x="68%" y="12%" class="align-center medium capitalize" style="fill:var(--theme-body-color);">
		...
		<g style="transform: translate(5%, 20%)">
			<g style="transform: translateY(10%)">
				<xsl:call-template name="lozenge-letter">
					...
					<xsl:with-param name="caption-width" select="format-number( //areas/area[1]/statistics/byValue/range[1]/@sold div $totalSales, '#%' )" />
					<xsl:with-param name="caption">
						<tspan x="0">
							<xsl:value-of select="//areas/area[1]/statistics/byValue/range[1]/@value" />
						</tspan>
						<tspan x="0" dy="3.5%">
							<xsl:text>Or Less</xsl:text>
						</tspan>
					</xsl:with-param>
					<xsl:with-param name="width" select="//areas/area[1]/statistics/byValue/range[1]/@sold div $maxSales" />
					<xsl:with-param name="diamond-caption" select="format-number( //areas/area[1]/statistics/byValue/range[1]/@sold div $totalSales, '#%' )" />
<xsl:with-param name="value" select="concat( //areas/area[1]/statistics/byValue/range[1]/@sold, ' sales' )" />
			...
			<g style="transform: translateY(30%)">
				<xsl:call-template name="lozenge-letter">
					...
					<xsl:with-param name="caption">
						...
						<tspan x="0" dy="3.5%">
							<xsl:value-of select="concat( 'To ', //areas/area[1]/statistics/byValue/range[3]/@value )" />
						</tspan>
					</xsl:with-param>
					<xsl:with-param name="width" select="//areas/area[1]/statistics/byValue/range[2]/@sold div $maxSales" />
					<xsl:with-param name="diamond-caption" select="format-number( //areas/area[1]/statistics/byValue/range[2]/@sold div $totalSales, '#%' )" />
<xsl:with-param name="value" select="concat( //areas/area[1]/statistics/byValue/range[2]/@sold, ' sales' )" />
			...
			<g style="transform: translateY(50%)">
				<xsl:call-template name="lozenge-letter">
					...
					<xsl:with-param name="caption">
						<tspan x="0">
							<xsl:value-of select="//areas/area[1]/statistics/byValue/range[3]/@value" />
						</tspan>
						<tspan x="0" dy="3.5%">
							<xsl:text>Or More</xsl:text>
						</tspan>
					</xsl:with-param>
					<xsl:with-param name="width" select="//areas/area[1]/statistics/byValue/range[3]/@sold div $maxSales" />
					<xsl:with-param name="diamond-caption" select="format-number( //areas/area[1]/statistics/byValue/range[3]/@sold div $totalSales, '#%' )" />
<xsl:with-param name="value" select="concat( //areas/area[1]/statistics/byValue/range[3]/@sold, ' sales' )" />
