<?xml version="1.0"?>
<!--
	Asset Name:	Banner Ad No.2
	Tags:		Social Marketing Ad
	Sizes:		Facebook, Postcard, Instagram Square, Linkedin, Twitter 
	Supports:	Area
	Render Key:	TheGenie-Banner-Ad-2-REPORTDATE-AREASLUG
-->
	...
	<xsl:template name="svg-body">
		<g>
			...
			<g class="align-center" style="transform: translate(10.2%,27%);">
				...
				<text x="16%" y="6%" class="heading upper" style="font-size:250%; font-weight:600;">
			...
			<image x="49%" y="20%" width="45%" height="62%" preserveAspectRatio="xMidYMid slice">
