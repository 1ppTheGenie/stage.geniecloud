...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.0" expand-text="yes">
							...
							<div class="col-md-3">
								<div class="agent-details agent-detail-wrapper">
									...
									<div class="details">
										...
										<button class="btn subtitle-font background-as-color contact-me-btn" style="display:none;">
							...
							<div class="col-md-3">
								<div class="agent-details agent-detail-wrapper">
									...
									<div class="details">
										...
										<h2 class="body-font agent-desig">
											<xsl:value-of select="//agent[2]/marketingTitle" />
										</h2>
										<h3 class="agent-phone">
											<a>
												<xsl:attribute name="href">
													<xsl:value-of select="concat( 'tel:',//agent[2]/mobile )" />
												</xsl:attribute>
												<xsl:value-of select="//agent[2]/mobile" />
											</a>
										</h3>
										<button class="btn subtitle-font background-as-color contact-me-btn" style="display:none;">
											<span class="contact-svg">
										...
										<h2 class="agent-website body-color body-font">
											<a target="_blank">
												<xsl:attribute name="href">
													<xsl:choose>
														<xsl:when test="substring( //agent[2]/website, 1, 4 ) = 'http'">
															<xsl:value-of select="//agent[2]/website" />
														</xsl:when>
														<xsl:otherwise>
															<xsl:value-of select="concat( 'https://', //agent[2]/website )" />
														</xsl:otherwise>
													</xsl:choose>
												</xsl:attribute>
												<xsl:value-of select="//agent[2]/website" />
										...
										<h4 class="agent-code body-color body-font">
											<xsl:value-of select="//agent[2]/marketingLicense" />
										</h4>
									</div>
									<div class="agent-logo">
										<div class="funnel-about-personal-logo">
											<div class="funnel-personal-logo genie-logo-light">
												<xsl:attribute name="style">
													<xsl:value-of select="concat( 'background: url(', //agent[2]/personalLogoLight, ')' )" />
												</xsl:attribute>
											</div>
											<div class="funnel-personal-logo genie-logo-dark">
												<xsl:attribute name="style">
													<xsl:value-of select="concat( 'background: url(', //agent[2]/personalLogoDark, ')' )" />
												</xsl:attribute>
											</div>
										</div>
									</div>
	...
	<xsl:for-each select="//listingAgent[string-length(normalize-space(@name)) > 0]">
		...
		<!-- Only show label if name is present -->
		<xsl:choose>
