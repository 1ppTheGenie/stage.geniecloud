...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.0" expand-text="yes">
	...
	<xsl:template name="flyer-footer">
		...
		<g style="transform:translate(0%,87.9%)">
			...
			<text x="98%" y="0.7%" class="align-right right theme-body" font-family="var(--theme-heading-font)" font-size="125%" font-weight="100">
				<tspan x="98%">
					<xsl:call-template name="editable">
			...
			<text x="98%" y="4%" class="align-right right theme-body" font-family="var(--theme-heading-font)" font-size="125%" font-weight="100">
				<tspan>
			...
			<text x="98%" y="7.1%" class="align-right right theme-body" font-size="80%" font-family="var(--theme-heading-font)" font-weight="100">
				<xsl:call-template name="editable">
			...
			<text x="51.5%" y="0.8%" class="theme-body center" font-family="var(--theme-heading-font)" font-size="130%" font-weight="300">
				<xsl:call-template name="editable">
