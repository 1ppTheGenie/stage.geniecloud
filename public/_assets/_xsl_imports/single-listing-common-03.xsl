...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.0" expand-text="yes">
	...
	<xsl:template name="single-listing-common-03">
		<style>
			<xsl:value-of select="'
		...
		<g style="transform: translate(0%,4%);">
			<image x="-1%" y="36%" width="10%" height="14%" preserveAspectRatio="xMidYMid meet">
				<xsl:attribute name="href">
			...
			<text class="sub-heading bold" style="transform:translate(8%,42%)">
				<tspan class="upper large" tabindex="1">
					<xsl:value-of select="$listingStatusCaption" />
				</tspan>
				<tspan class="medium"> in </tspan>
				<tspan class="medium">
...
<xsl:call-template name="listing-address" />
		...
		<foreignObject x="2%" y="51%" width="62%" height="30%">
			<p style="color:var(--theme-body-color);-webkit-line-clamp:8; text-align: justify;">
		...
		<g style="transform:translate(0%,81.5%)">
			<svg width="35%" height="17.5%">
				...
				<text x="23%" y="26%" font-size="145%" fill="var(--theme-body-color)">
					<xsl:call-template name="editable">
				...
				<text x="27%" y="45%" fill="var(--theme-sub-heading-color)" style="font-size:90%;">
					<xsl:call-template name="editable">
				...
				<text x="27%" y="59%" fill="var(--theme-sub-heading-color)" style="font-size:90%;">
					<xsl:call-template name="editable">
				...
				<text x="27%" y="75%" fill="var(--theme-sub-heading-color)" style="font-size:90%;">
					<xsl:call-template name="editable">
		...
		<g style="transform:translate(67%,42%);">
			<text x="16%" y="6%" class="sub-heading medium bold align-center">
				<tspan>
...
<xsl:value-of select="//single/type" />
			...
			<g style="transform:translate(0,14%)">
				...
				<g class="icon-stat" style="transform:translate(0,19%)">
					...
					<text class="align-center" style="font-size: 80%;">
						<tspan x="5%" y="11%" tabindex="3" data-name="square-foot-price" data-default="My default string">
							<xsl:call-template name="editable">
						...
						<tspan x="5%" y="14%" tabindex="3" data-name="sqf-caption-1" data-default=" Price per">
							<xsl:call-template name="editable">
								<xsl:with-param name="id" select="'priceper'" />
								<xsl:with-param name="default" select="'Price per'" />
							</xsl:call-template>
						</tspan>
						<tspan x="5%" y="16%" tabindex="4" data-name="sqf-caption-2" data-default=" Sq.Ft.">
							<xsl:call-template name="editable">
				...
				<g class="icon-stat" style="transform:translate(11%,19%)">
					...
					<text class="align-center" tabindex="5">
						<tspan x="5%" y="11%" style="font-size:75%!important;">
							<xsl:choose>
						...
						<tspan x="5%" y="14%" style="font-size:80%!important;">
							<xsl:choose>
								<xsl:when test="//single/soldDate!=''">
									<xsl:call-template name="editable">
