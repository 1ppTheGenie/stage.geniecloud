...
var listS3Folder = async (folderPath = "", bucket = null) => {
  try {
    ...
    const response = await s3Client.send(new import_client_s3.ListObjectsV2Command(listParams));
...
var toS3 = async (key, buffer, tags = null, mimeType = null, bucket = null) => {
