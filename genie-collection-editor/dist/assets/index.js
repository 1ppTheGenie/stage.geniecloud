...
const _tmpl$$c = /*#__PURE__*/template(`<div class="collection-box collection-header"><div class="input-grid"><span>Collection:</span><input class="focussed" placeholder="Collections must have name" type="text"><span>Collection Template:</span><select aria-label="Collection Template" class="focussed" default="default"></select><span>Filename:</span><input class="focussed" type="text"></div><div class="flex-row" style="margin-top:2rem;"><button type="button">Save</button><button type="button">Duplicate`),
  _tmpl$2$5 = /*#__PURE__*/template(`<div id="sections"><h2>Sections</h2><button type="button">Add Section`),
  _tmpl$3$2 = /*#__PURE__*/template(`<option>`);
...
const Collection = props => {
  ...
  return [(() => {
    ...
    insert(_el$6, createComponent(For, {
      get each() {
        return Object.keys(app.store.allAssets?.collections);
      },
      children: a => (() => {
        const _el$15 = _tmpl$3$2();
        insert(_el$15, () => app.store.allAssets.collections[a].name);
        createRenderEffect(() => _el$15.value = a.replace(".xsl", ""));
        return _el$15;
      })()
    }));
    _el$8.addEventListener("change", e => setFilename(e.target.value));
    _el$10.$$click = async () => await localSave("Collection saved!");
    _el$11.$$click = async () => {
...
const _tmpl$$9 = /*#__PURE__*/template(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><path d="M88 160H38.7c-3.7 0-6.7-3-6.7-6.7 0-1.9.8-3.7 2.2-5L160 35.8l125.8 112.5c1.4 1.3 2.2 3.1 2.2 5 0 3.7-3 6.7-6.7 6.7H232c-17.7 0-32 14.3-32 32v272c0 8.8-7.2 16-16 16h-48c-8.8 0-16-7.2-16-16V192c0-17.7-14.3-32-32-32zM174 5.3c-3.9-3.4-8.8-5.3-14-5.3s-10.1 1.9-14 5.3L12.9 124.5C4.7 131.8 0 142.3 0 153.3 0 174.7 17.3 192 38.7 192H88v272c0 26.5 21.5 48 48 48h48c26.5 0 48-21.5 48-48V192h49.3c21.4 0 38.7-17.3 38.7-38.7 0-11-4.7-21.5-12.9-28.8L174 5.3z">`);
const Up = ((props = {}) => (() => {
  const _el$ = _tmpl$$9();
  spread(_el$, props, true, true);
  return _el$;
...
const _tmpl$$8 = /*#__PURE__*/template(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><path d="M88 352H38.7c-3.7 0-6.7 3-6.7 6.7 0 1.9.8 3.7 2.2 5L160 476.2l125.8-112.5c1.4-1.3 2.2-3.1 2.2-5 0-3.7-3-6.7-6.7-6.7H232c-17.7 0-32-14.3-32-32V48c0-8.8-7.2-16-16-16h-48c-8.8 0-16 7.2-16 16v272c0 17.7-14.3 32-32 32zm86 154.7c-3.8 3.4-8.8 5.3-14 5.3s-10.1-1.9-14-5.3L12.9 387.5C4.7 380.2 0 369.7 0 358.7 0 337.3 17.3 320 38.7 320H88V48c0-26.5 21.5-48 48-48h48c26.5 0 48 21.5 48 48v272h49.3c21.4 0 38.7 17.3 38.7 38.7 0 11-4.7 21.5-12.9 28.8L174 506.7z">`);
const Down = ((props = {}) => (() => {
  const _el$ = _tmpl$$8();
  spread(_el$, props, true, true);
  return _el$;
...
const _tmpl$$5 = /*#__PURE__*/template(`<input type="text" class="focussed" placeholder="Enter custom url or blank for agent website.">`),
  _tmpl$2$3 = /*#__PURE__*/template(`<tr><td></td><td><input class="focussed" placeholder="Override name"></td><td style="text-transform:capitalize"></td><td></td><td></td><td></td><td class="actions">`),
  _tmpl$3$1 = /*#__PURE__*/template(`<span style="opacity:0.2">-`),
  _tmpl$4 = /*#__PURE__*/template(`<select aria-label="Landing Pages" class="focussed"><option value="0">`),
  _tmpl$5 = /*#__PURE__*/template(`<option>`);
const Asset = props => {
  const asset = app.store.allAssets[props.asset.folder][props.asset.stylesheet + ".xsl"];
  return createComponent(Show, {
    ...
    get children() {
        ...
        get children() {
          return [createComponent(LandingPages, {
            ...
            get children() {
              ...
              _el$9.style.setProperty("width", "275px");
      ...
      insert(_el$10, createComponent(Trash, {
        style: "fill:var(--genie-primary);",
...
const LandingPages = props => (() => {
  ...
  _el$13.addEventListener("change", e => props.onChange(e.target.value !== "0" ? e.target.value : null));
  insert(_el$14, () => props.defaultCaption);
  insert(_el$13, createComponent(For, {
    get each() {
      return app.currentLandingPages(props.incLPOs);
    },
    children: lp => lp !== props.actual && (() => {
      const _el$15 = _tmpl$5();
      insert(_el$15, lp);
      createRenderEffect(() => _el$15.selected = props.current == lp);
      return _el$15;
    })()
  }), null);
  return _el$13;
...
const _tmpl$$3 = /*#__PURE__*/template(`<tr><td><select aria-label="Assets"></select></td><td colspan="3" class="actions">`),
  _tmpl$2$2 = /*#__PURE__*/template(`<optgroup>`),
  ...
  return (() => {
    ...
    insert(_el$3, createComponent(For, {
      ...
      children: key => (() => {
        ...
        setAttribute(_el$5, "label", key);
        insert(_el$5, createComponent(For, {
          get each() {
            return Object.keys(app.store.allAssets[key]);
          },
          children: key2 => (() => {
            const _el$6 = _tmpl$3();
            _el$6.value = `${key}/${key2}`;
            insert(_el$6, () => app.store.allAssets[key][key2].name);
            return _el$6;
          })()
        }));
        return _el$5;
...
const _tmpl$$2 = /*#__PURE__*/template(`<thead style="text-align:left;"><tr><th>Asset Name</th><th>Name Override</th><th>Type</th><th>Supports</th><th>LPO for</th><th>QR Destination</th><th>`),
...
const Section = props => {
  ...
  return (() => {
    ...
    insert(_el$12, createComponent(NewAsset, {
      get currentAssets() {
        return props.section.assets;
      },
      addAsset: addAsset
    }), null);
    _el$14.$$click = () => props.removeSection();
...
const _tmpl$ = /*#__PURE__*/template(`<div style="background-color:var(--genie-background);color:var(--genie-white);"><span style="float:right;font-size:75%;font-weight:bold;margin:1rem;"></span><h1 style="margin:0;padding:2rem;display:flex;align-items:center;">Genie Collection Editor`),
  _tmpl$2 = /*#__PURE__*/template(`<main style="margin:4rem;">`);
function App() {
  return [(() => {
    const _el$ = _tmpl$(),
      _el$2 = _el$.firstChild,
    ...
    insert(_el$3, createComponent(Show, {
      ...
      get children() {
        return [" - ", " ", createMemo(() => app.currentCollection()?.name)];
      }
    }), null);
    return _el$;
  })(), (() => {
