...
import { areaDataStore, propertyTypeCaption, periodName, percent } from "@/utilities";

export const MarketComment = () => {
	return (
		<p style="margin: 2% 20%" classList={{ loading: areaDataStore.loading }}>
			The number of closed {areaDataStore.areaName} {propertyTypeCaption()} sales
			...
			<Show when={!areaDataStore.loading}>
				{areaDataStore.soldDelta <= -0.05 && (
					<>
						...
						{propertyTypeCaption()} market creates a huge demand from
				...
				{areaDataStore.soldDelta >= 0.05 && (
					<>
						...
						{propertyTypeCaption()} market means more possible competition
				...
				{areaDataStore.soldDelta > -0.05 && areaDataStore.soldDelta < 0.05 && (
					<>
						...
						{propertyTypeCaption()} market is steady and healthy. If you're
